...
%%
datapath = ['/Users/Erfan/Desktop/Monkey NeuroPixel/gandalf_20231223_lfp/gandalf_20231223_g0'];
channelMapFile = 'neuropixPhase3A_kilosortChanMap.mat';
channelMapFile = 'neuropixels_NHP_channel_map_linear_v1.mat';

imec = Neuropixel.ImecDataset('/Users/Erfan/Desktop/Monkey NeuroPixel/gandalf_20231223_lfp/gandalf_20231223_g0/gandalf_20231223_g0_imec1/gandalf_20231223_g0_t0.imec1.lf.bin', 'channelMap', channelMapFile)
%%
...
ksPath = '/data/kilosort/neuropixel_01.imec.ap.bin';imec = imec.symLinkAPIntoDirectory(ksPath);
%%
% Inspect the raw IMEC traces
imec.inspectAP_timeWindow([1 10]) % 200-201 seconds into the recording
%%
